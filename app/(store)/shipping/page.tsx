  ...
  return (
    <div className="pt-24 pb-16 md:pt-32 md:pb-24 min-h-screen">
      <div className="container mx-auto px-4 max-w-3xl">
        <h1 className="text-4xl font-serif mb-12 text-center">Shipping Information</h1>
        
        <div className="prose prose-neutral max-w-none">
          <p className="text-muted-foreground leading-relaxed mb-6">
            This is a demo page for Shipping Information. In a real production environment, this page would contain detailed legal, operational, or brand information.
          </p>
          <p className="text-muted-foreground leading-relaxed mb-6">
