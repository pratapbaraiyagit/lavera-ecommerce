...
export default function CustomerDirectoryAdminPage() {
  return (
    <div>
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-2xl font-serif mb-2">Customer Directory</h1>
          <p className="text-sm text-muted-foreground">View customer accounts and purchase history.</p>
        </div>
